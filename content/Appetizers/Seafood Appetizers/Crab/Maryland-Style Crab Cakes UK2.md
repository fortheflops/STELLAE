...
recipe:
  ...
  image:
    - "https://cucinamezzaluna.com/Appetizers/Seafood-Appetizers/Crab/Assets/Handwritten_2025-01-19_112013.webp"
  prepTime: PT15M
  cookTime: PT10M
  totalTime: PT25M
  recipeYield: "8 crab cakes"
  ...
  recipeIngredient:
    ...
    - "1 cup fine cracker crumbs (such as saltines)"
    - "Vegetable oil or butter, for frying"
  recipeInstructions:
    - "@type": HowToStep
      text: "In a medium bowl, gently combine the crab meat, eggs, mayonnaise, horseradish, parsley, Tabasco, salt, and pepper. Do not overmix."
    - "@type": HowToStep
      text: "Shape the mixture into cakes, about 1/2 to 3/4 inch thick."
    - "@type": HowToStep
      text: "Place cracker crumbs on a plate and gently coat each crab cake on both sides."
    - "@type": HowToStep
      text: "Heat oil or butter in a large skillet over medium-high heat."
    - "@type": HowToStep
      text: "Carefully place the crab cakes in the skillet and fry for about 3-5 minutes per side, until golden brown and heated through."
    - "@type": HowToStep
      text: "Remove from the skillet and drain on paper towels. Serve immediately."
---

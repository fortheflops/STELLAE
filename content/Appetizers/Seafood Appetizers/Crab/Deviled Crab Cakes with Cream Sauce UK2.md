...
recipe:
  ...
  "@type": Recipe
  name: "Deviled Crab Cakes with Cream Sauce"
  author:
    "@type": Person
    name: "Unknown"
  ...
  recipeIngredient:
    ...
    - "1/2 to 1 cup cracker meal, plus more for coating"
    - "1 large egg, beaten"
    - "Vegetable oil or other fat, for frying"
  recipeInstructions:
    - "@type": HowToStep
      text: "First, make the Thick Cream Sauce: In a small saucepan, melt 2 tbsp butter over medium heat. Whisk in 2 tbsp flour and cook for one minute. Gradually whisk in 1 cup of milk until smooth. Simmer, stirring, until very thick. Season with salt and pepper and set aside."
    - "@type": HowToStep
      text: "In a skillet, melt 1 tbsp butter. Sauté the chopped onion and green pepper until soft."
    - "@type": HowToStep
      text: "In a large bowl, combine the sautéed vegetables, prepared cream sauce, crab meat, thyme, parsley, and celery flakes. Season with salt and pepper and mix thoroughly."
    - "@type": HowToStep
      text: "Stir in enough cracker meal (about 1/2 to 1 cup) to make the mixture reach a mashed potato consistency. Mix well."
    - "@type": HowToStep
      text: "Cover the mixture and refrigerate for several hours until firm."
    - "@type": HowToStep
      text: "Shape the chilled mixture into small patties. Dip each patty into a bowl with the beaten egg, then coat thoroughly with additional cracker meal."
    - "@type": HowToStep
      text: "In a large skillet, heat a small amount of fat or oil over medium-high heat. Fry the crab cakes until golden brown on both sides."
---

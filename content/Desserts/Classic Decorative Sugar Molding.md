...
> *A classic recipe and technique for creating beautiful, hollow molded sugar shapes. This method uses a simple sugar and egg white mixture, perfect for making panoramic Easter eggs or other delicate decorations.*

---

| Prep Time | Cook Time | Inactive / Chill Time | Yield / Servings |
| :--- | :--- | :--- | :--- |
| 15 mins | 10 mins | Until dry | Varies |
...
2. In a mixing bowl, combine the **1 unbeaten egg white**, **1/2 cup powdered sugar**, and **3 1/2 cups granulated sugar**. Add **food coloring** if desired.
...
4. Pack the sugar mixture firmly into a mold, pressing it into all the details.
5. Invert the mold onto a baking sheet and carefully lift it off, leaving the sugar shape intact.
6. Bake for **5 to 10 minutes** until a hardened outer shell forms.

### Step 3: Hollow and Dry
7. After baking, carefully scoop out the soft, unhardened sugar from the inside with a small spoon to create a hollow shell.
8. Allow the molded sugar shells to air dry completely until they are rock hard and durable.

---

> 💡 **Make-Ahead & Storage:** Store the completely dried sugar molds in an airtight container in a cool, dry place indefinitely. Avoid any moisture or humidity, which will cause the sugar to dissolve.

---
## Original Recipe Scan
![Original Handwritten Card](Handwritten_2025-05-20_131501.webp)
